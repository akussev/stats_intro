...
Код сего документа открыт и доступен в \href{https://www.overleaf.com/read/tdmvvfrmgzks#053aa4}{Overleaf} и \href{https://github.com/akussev/stats_intro}{GitHub}, там же можно найти актуальную версию PDF.

\newpage
% \setcounter{section}{-1}
% \input{src/prerequisite}
% \newpage
\part{Параметрический подход}
\input{src/estimators}
\include{src/methods}
\include{src/compare}
\include{src/mle}
\include{src/sufficiency}
\include{src/confidence_interval}
\newpage
\part{Проверка статистических гипотез}
\input{src/test_intro}
\include{src/umpt}
\include{src/general_test}
\include{src/special_test}
\include{src/correlation}
\include{src/homogeneity_test}
\include{src/multiple_testing}
\newpage
\part{Прочие модели и методы в статистике}
\input{src/regression}
\include{src/bayes}
\include{src/robust}
